<?php
// superadmin/analytics.php - Comprehensive System Analytics Dashboard
...
<head>
    ...
    <title>System Analytics - Fitish Pro</title>
        ...
        <main class="main-content">
            ...
            <div class="dashboard-content">
                ...
                <div class="analytics-nav">
                    ...
                    <a href="?view=system" class="nav-button <?php echo $viewType === 'system' ? 'active' : ''; ?>">
                ...
                <?php if ($viewType === 'overview' || $viewType === ''): ?>
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-number"><?php echo $userAnalytics['admins'] ?? 0; ?></div>
                            <div class="stat-label">Admins</div>
                            <div class="stat-change"><?php echo $userAnalytics['superadmins'] ?? 0; ?> superadmins</div>
                        </div>
                    </div>
                ...
                <?php elseif ($viewType === 'system'): ?>
                    <!-- System Health -->
                    <div class="stats-grid">
                        <div class="stat-card">
                            <div class="stat-icon"><i class="fas fa-database"></i></div>
                            <div class="stat-number"><?php echo count($systemHealth['database_tables'] ?? []); ?></div>
                            <div class="stat-label">Database Tables</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-icon"><i class="fas fa-sync-alt"></i></div>
                            <div class="stat-number"><?php echo $systemHealth['active_sessions'] ?? 0; ?></div>
                            <div class="stat-label">Active Sessions</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-icon"><i class="fas fa-clipboard-list"></i></div>
                            <div class="stat-number"><?php echo $systemHealth['recent_admin_activities'] ?? 0; ?></div>
                    ...
                    <div class="table-section">
                        ...
                        <div class="table-responsive">
                            <table class="analytics-table">
                                ...
                                <tbody>
                                    <?php foreach ($systemHealth['database_tables'] ?? [] as $table): ?>
                                        <tr>
                                            <td>
                                                <div style="display: flex; align-items: center; gap: 0.5rem;">
                                                    <i class="fas fa-table" style="color: var(--primary);"></i>
                                                    <code style="background: var(--bg-muted); padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-size: 0.875rem;">
